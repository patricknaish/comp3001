...
\item
Google App Engine Runner (described below)
\end{itemize}
...
\subsection{External Sources Used}

The jQuery framework (http://jquery.com) was used for Javascript.
jQuery UI (http://jqueryui.com) was used for CSS and styling of certain UI elements.
